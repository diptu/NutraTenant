...
Distinct from app.api.v1.organizations.routes (the pre-existing
organization-bootstrap API, where "tenant_id" means Organization.slug) —
see app.modules.tenants.service for the full rationale. Entirely
...
from app.api.v1.tenants.requests import (
    LinkOrganizationRequest,
    TenantGroupCreateRequest,
    TenantGroupUpdateRequest,
)
from app.api.v1.tenants.responses import TenantGroupOrganizationOut, TenantGroupOut
