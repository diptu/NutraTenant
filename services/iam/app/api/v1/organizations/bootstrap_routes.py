"""Tenant-scoped invitation creation and the root tenant-bootstrap API.
...
from app.api.v1.organizations.requests import CreateInviteRequest, CreateTenantRequest
...
from app.modules.roles.service import DEFAULT_ORG_ROLES
...
async def create_tenant_invite(
    ...
    if not current_user.is_superuser and session_tenant_id != tenant_id:
