...
JWKS verification — see app.infrastructure.security.google_oidc) to encrypt
the TOTP secret at rest: unlike a password, it can't be one-way hashed,
since verifying a code needs the original secret back.
"""
